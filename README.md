...
- Use Deno
  ```bash
  $ deno install --allow-read --force -n base85 https://github.com/redpeacock78/base85/raw/v0.0.10/cli.ts
  $ base85 -V
  ```
- Download Binary
  ```bash
  # Linux_x86
  $ curl -sL https://github.com/redpeacock78/base85/releases/download/v0.0.10/base85-linux-x86 -o /usr/local/bin/base85
...
### Deno module
```typescript
import { base85encode, base85decode } from "https://github.com/redpeacock78/base85/raw/v0.0.10/mod.ts";
